const employee = {
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" v-model="employeeID" placeholder="Enter employee Id">
                                    </div>
                                    ...
                                    <button type="button" @click="createEmployee()" v-if="!isForUpdateForm" class="btn btn-primary btn-create">Create</button>
    ...
    methods: {
        ...
        refreshData () {
            ...
            .then((response) => {
                // Push the response data to employee object
        ...
        */
        ...
        /*
        * Action for Edit Employee button
        */
        ...
        */
        createEmployee () {
            ...
            if (!this.validateForm()) {
                ...
                axios.get(variables.API_URL + "employees/"  + this.employeeID)
                .then((response) => {
                    // Create new employee
